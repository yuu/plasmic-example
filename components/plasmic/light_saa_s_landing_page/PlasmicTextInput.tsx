...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: KoPO2m1q8YFLOe/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder: "Fill your email address" as const
        },
        props.args
      ),
    [props.args]
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg__sc7M)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4Q7DA)}
                role={"img"}
              />
            ),
