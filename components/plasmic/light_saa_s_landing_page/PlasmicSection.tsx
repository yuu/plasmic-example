...
import sty from "./PlasmicSection.module.css"; // plasmic-import: 2u2xAP9HZsIKg_/css
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          [sty.rootbackground_blue]: hasVariant(variants, "background", "blue"),
          ...
          [sty.rootsize_faq]: hasVariant(variants, "size", "faq"),
