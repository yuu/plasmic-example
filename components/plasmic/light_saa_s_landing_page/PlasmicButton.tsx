...
import sty from "./PlasmicButton.module.css"; // plasmic-import: WV3AsyL6gDT7Ei/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___5Gcyn)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__sz2UJ)}
                role={"img"}
              />
            ),
